...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("assets/AndroidManifest.xml", "assets_androidmanifest_xml");
			resourceTypes.set ("assets/AndroidManifest.xml", "text");
			resourceNames.set ("assets/COPYRIGHT.TXT", "assets_copyright_txt");
			resourceTypes.set ("assets/COPYRIGHT.TXT", "text");
			resourceNames.set ("assets/nme2.svg", "assets_nme2_svg");
			resourceTypes.set ("assets/nme2.svg", "text");
			resourceNames.set ("assets/VeraSe.ttf", "assets_verase_ttf");
			resourceTypes.set ("assets/VeraSe.ttf", "font");
			resourceNames.set ("assets/VeraSeBd.ttf", "assets_verasebd_ttf");
			resourceTypes.set ("assets/VeraSeBd.ttf", "font");
